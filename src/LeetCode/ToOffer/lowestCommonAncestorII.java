...
public class lowestCommonAncestorII {
    ...
    public static void main(String[] args) {
        ...
        Solution lowestCommonAncestorSolution = new Solution();
        int pVal = 6;
        int qVal = 0;
        TreeNode p = findNode(pVal, root);
        TreeNode q = findNode(qVal, root);
        TreeNode ans = lowestCommonAncestorSolution.lowestCommonAncestor(root, p, q);
        System.out.println(ans.val);
    }

    private static TreeNode findNode(int val, TreeNode root) {
